...
SERVER_URL = "https://localhost:33335" # 注意：如果是https，需确保SSL证书配置正确或忽略验证
...
CONFIGS = [
    {"res": (640, 480), "fps": 10, "duration": 10},
    {"res": (640, 480), "fps": 15, "duration": 10},
    {"res": (640, 480), "fps": 20, "duration": 10},
    {"res": (640, 480), "fps": 30, "duration": 10},
    {"res": (1280, 720), "fps": 10, "duration": 10},
    {"res": (1280, 720), "fps": 15, "duration": 10},
    {"res": (1280, 720), "fps": 20, "duration": 10},
    {"res": (1280, 720), "fps": 30, "duration": 10},
]
...
class BenchmarkClient:
    ...
    def _bind_socket_events(self):
        ...
        async def on_ai_result(data):
            ...
            recv_time = time.time()
            e2e_delay = (recv_time - data['timestamp']) * 1000 
